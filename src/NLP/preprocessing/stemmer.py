...
class Stemmer:
    ...
    def step_1_b(self, word):
        ...
        if(word.endswith(self.__step1b_suffixes[0][0]) and self.determine_m(word[:-len(self.__step1b_suffixes[0][0])]) > 0):
            return word[:-len(self.__step1b_suffixes[0][0])] + self.__step1b_suffixes[0][1]
            
        if (word.endswith(self.__step1b_suffixes[1][0]) and self.contains_vowel(word[:-len(self.__step1b_suffixes[1][0])])):
            return self.step_1_2b(word[:-len(self.__step1b_suffixes[1][0])] + self.__step1b_suffixes[1][1])
             
        if (word.endswith(self.__step1b_suffixes[2][0]) and self.contains_vowel(word[:-len(self.__step1b_suffixes[2][0])])):
            return self.step_1_2b(word[:-len(self.__step1b_suffixes[2][0])] + self.__step1b_suffixes[2][1])
